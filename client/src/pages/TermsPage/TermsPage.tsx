...
const TermsPage: FC<Props> = () : JSX.Element => {
  return (
    <Container maxWidth='lg'>
      ...
      <Typography variant='body2' style={{ color: 'white', paddingBottom: 30 }}>
        ...
        By using this site and/or by submitting any content (including posts, photos, comments, and any other material), you agree to the following terms:
      </Typography>
